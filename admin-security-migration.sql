...
-- Products: only approved admins can create/update/delete.
...
-- Orders: only approved admins can inspect/update orders.
...
-- Product images: only approved admins can upload or delete.
